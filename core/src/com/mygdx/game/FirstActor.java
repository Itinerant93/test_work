...
public class FirstActor extends CommonActor {


    public FirstActor(String name_texture, int _duration, int x) {
    ...
    public float parabola (float x) {
        return (float) Math.pow((x - Gdx.graphics.getWidth()/2.0f + 128 / 2), 2) / (Gdx.graphics.getHeight() / 2.0f - 64);
    }
}